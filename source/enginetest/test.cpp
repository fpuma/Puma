...
namespace Game
{
    ...
    void Test::updateTest()
    {
        ...
        puma::ILocationComponent* locationComponent = componentProvider->get<puma::ILocationComponent>( BallSpawner );
        puma::IInputComponent* inputComponent = componentProvider->get<puma::IInputComponent>( BallSpawner );

        if ( inputComponent->isActionActive( SpawnBallAction ) )
        {
    ...
    {
        unspawnBallSpawner( BallSpawner );
